...
import lk.ijse.gdse70.agreebloom.exception.*;
...
//is used in spring boot to handles exceptions globally for all Rest controllers
//Allowing centralized error handling and custom response

//form lombok automatically provides a logger instance named log
//making it easy to log messages for debugging and monitoring without manually creating logger
